...
def get_all() -> list[Student]:
    db = Database()
    sql = "SELECT id, fullname, gender, status, dateOfBirth, academicYear, address, ethnicity, religion, nationality, departmentID FROM Student"
...
def get_by_id(student_id: int) -> Student:
    db = Database()
    sql = "SELECT id, fullname, gender, status, dateOfBirth, academicYear, address, ethnicity, religion, nationality, departmentID FROM Student WHERE id = %s"
...
def get_by_department_id(department_id: int) -> list[Student]:
    db = Database()
    sql = "SELECT id, fullname, gender, status, dateOfBirth, academicYear, address, ethnicity, religion, nationality, departmentID FROM Student WHERE departmentID = %s"
