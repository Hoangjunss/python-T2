...
def createBottomBorder(frame, localY):
...
# buttonFaceId = tk.Button(frame, text = "Nhận diện khuôn mặt sinh viên", font = ("Times New Roman", 15), height = 2, bd = 0, bg = "white", fg= "red", command = open_camera)
...
buttonImgStudent.config(command = lambda: open_image(imgStudent))
...
buttonAdd.bind("<Enter>", on_mouse_enter)
buttonAdd.bind("<Leave>", on_mouse_leave)

buttonFaceId = tk.Button(frame, text = "Nhận diện khuôn mặt sinh viên", font = ("Times New Roman", 15), height = 2, bd = 0, bg = "white", fg= "red", command = open_camera)
buttonFaceId.place(x = 830, y = 350)
buttonFaceId.bind("<Enter>", on_mouse_enter)
buttonFaceId.bind("<Leave>", on_mouse_leave)
